...
import {
 IoCamera, IoLocationOutline,
  IoMailOutline, IoCheckmark,
...
const ProfileHeader = ({
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        // Update the avatar field in your parent state
         ...
         {/* Profile Image Section */}
          ...
          <div className="flex-1 w-full text-center sm:text-left space-y-3">
              ...
              {editSection === "name" ? (
                <div className="flex items-center gap-2 ">
                  <input
                    ...
                    autoFocus
                  />
                  <button onClick={() => setEditSection(null)} className="text-secondary">
                    <IoCheckmark size={22} />
                  </button>
                </div>
              ) : (
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 text-gray-500">
              ...
              <span className="text-sm cursor-not-allowed select-none">{user.email}</span>
            </div>
            {/* City */}
            <div className="flex items-center justify-center sm:justify-start gap-1 text-sm text-gray-600">
              ...
              {editSection === "city" ? (
                ...
                <>
                  <span className="text-sm me-2">{formData.city || "City not set"}</span>
                  <MdOutlineEdit
                                       size={24}
                    className="text-gray-700 hover:text-secondary cursor-pointer"
