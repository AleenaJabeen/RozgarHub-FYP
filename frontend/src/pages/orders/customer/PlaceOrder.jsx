...
const PlaceOrder = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pt-10">
      ...
      {locLoading ? (
        // ✅ Smoother, cleaner loading state with Orange theme
        <div className="flex-1 flex flex-col items-center justify-center gap-5 mt-[-10vh]">
          <div className="relative">
            <div className="absolute inset-0 bg-orange-200 rounded-full animate-ping opacity-70"></div>
            <div className="relative bg-white p-4 rounded-full shadow-md border border-orange-100">
              <FaBolt className="text-orange-500 text-2xl animate-pulse" />
            </div>
          </div>
          <p className="text-sm text-orange-800 font-bold tracking-wide animate-pulse">
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            {/* Page Header */}
            {/* ✅ Updated gradient to a punchy Orange scheme */}
            <div className={`px-8 py-7 text-white ${isBroadcast ? 'bg-gradient-to-r from-orange-500 to-orange-600' : 'bg-secondary'}`}>
